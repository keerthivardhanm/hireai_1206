...
export function Drawer({ isOpen, onClose, title, children, side = 'right' }: DrawerProps) {
  ...
  const translateX = side === 'right' ? 'translate-x-full' : '-translate-x-full';
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div
        className={`
          fixed inset-y-0 ${side === 'right' ? 'right-0' : 'left-0'}
          w-full max-w-md bg-white shadow-xl flex flex-col
    ...
    <Modal isOpen={isOpen} onClose={onClose} size="sm">
      <div className="text-center">
        <div className={`
          ...
          ${variant === 'danger' ? 'bg-red-50' : variant === 'warning' ? 'bg-orange-50' : 'bg-blue-50'}
        `}>
          {variant === 'danger' && (
